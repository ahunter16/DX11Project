...
ShadowMapClass::ShadowMapClass(const ShadowMapClass& other)
{}
...
bool ShadowMapClass::Initialize(ID3D11Device* device, int textureWidth, int textureHeight, float screenDepth, float screenNear)
{
...
void ShadowMapClass::ClearRenderTarget(ID3D11DeviceContext* deviceContext, float red, float green, float blue, float alpha)
{
	float color[4];
...
void ShadowMapClass::GetProjectionMatrix(D3DXMATRIX& projectionMatrix)
{
...
void ShadowMapClass::GetOrthoMatrix(D3DXMATRIX& orthoMatrix)
{
