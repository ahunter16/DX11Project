...
bool LightShaderClass::Render(	ID3D11DeviceContext* deviceContext, int indexCount, 
	...
	D3DXVECTOR4 ambientColor, D3DXVECTOR3 lightDirection, D3DXVECTOR4 diffuseColor, 
	float deltavalue, D3DXVECTOR3 cameraPosition, D3DXVECTOR4 specularColor, 
	float specularPower, ID3D11ShaderResourceView* texture)
{
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, 
		ambientColor, lightDirection, diffuseColor, deltavalue, cameraPosition, specularColor, 
		specularPower, texture);
	if(!result)
	{
		return false;
	}
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	//Setup the description of the camera position constant buffer that is in the pixel shader.
	//Note that ByteWidth always needs to be a multiple of 16 if using D3D11_BIND_CONSTANT_BUFFER or CreateBuffer will fail.
...
bool LightShaderClass::SetShaderParameters(	ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
											D3DXMATRIX projectionMatrix, D3DXVECTOR4 ambientColor, D3DXVECTOR3 lightDirection, 
											D3DXVECTOR4 diffuseColor, float deltavalue, D3DXVECTOR3 cameraPosition, 
